...
namespace Mimic {
	...
	public static class ArrayUtils {
		...
		public static T Remove<T>(this List<T> list, Predicate<T> match) {
			return list.Remove<T>(list.FindIndex(match));
		}
		...
		public static T RemoveLastElement<T>(this IList<T> list) {
		...
		public static List<T> GetSublist<T>(this IList<T> list, int startIndex, int length) {			
			List<T> sublist = new List<T>(length);
